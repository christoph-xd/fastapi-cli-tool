...
custom_style_fancy = questionary.Style([
    ...
    ('highlighted', 'fg:#019E00 bold'), # pointed-at choice in select and checkbox prompts
...
def binary_question(option: str) -> questionary.Question:
    return questionary.confirm(f"Do you want {option}?", default=False, style=custom_style_fancy)
